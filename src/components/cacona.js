...
const EXAMPLES = [
  'Chacabuco 847, Nueva Cordoba, Cordoba, Argentina',
...
export default class Cacona extends React.Component {
  ...
  _attemptGeocodeAsync = async () => {
    ...
    try {
      console.log('address cacona: ', this.state.selectedExample);
      let result = await Location.geocodeAsync(this.state.selectedExample);
      console.log('result cacona: ', result);
      this.setState({ result });
    } catch (e) {
