...
class PaymentSettings extends Component {
  ...
  renderConfirmMPagoSwitch = () => {
    // ventana de confirmación para habilitar/deshabilitar pago
    return (
      <Menu
      ...
      >
        <MenuItem title="Confirmar" icon="md-checkmark" onPress={this.onConfirmButtonPress} />
      ...
      >
        ...
        {this.props.hasAnyMPagoToken ? (
          <View>
            <CardSection style={styles.stateCardSection}>
              <View style={styles.stateTextContainer}>
                <Text style={styles.stateTextStyle}>{this.props.mPagoToken ? 'Habilitado' : 'Deshabilitado'}</Text>
              </View>
          ...
          <View>
            <CardSection style={styles.stateCardSection}>
              <View style={styles.stateTextContainer}>
                <Text style={styles.stateTextStyle}>Deshabilitado</Text>
              </View>
              <View style={{ alignItems: 'flex-end' }}>
                <Ionicons name="md-close-circle" color={MAIN_COLOR} size={23} />
              </View>
            </CardSection>
            <CardSection>
              <Button title="Comenzar a Cobrar" onPress={() => this.props.navigation.navigate('paymentSettingsWeb')} />
            </CardSection>
          </View>
        )}
      </Card>
