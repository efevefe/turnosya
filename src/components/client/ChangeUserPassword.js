...
class ChangeUserPassword extends Component {
    ...
    newPasswordError = () => {
        if (this.props.newPassword === '') {
            ...
            this.setState({ newPasswordError: 'La nueva contraseña debe ser diferente a la actual' });
        } else {
                ...
                <Card containerStyle={{
                    ...
                    <CardSection>
                        <Input
                            ...
                            onChangeText={value =>
                                this.props.onClientDataValueChange({ prop: 'password', value })
                            }
                    ...
                    <CardSection>
                        <Input
                            ...
                            onChangeText={value =>
                                this.props.onClientDataValueChange({ prop: 'confirmPassword', value })
                            }
